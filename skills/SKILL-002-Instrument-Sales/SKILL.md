...
At the natural end of a sale ("Done"), present the session-updates file and remind once: "Download this and drop it in `/updates/` — Claude Code merges these into the real files."
