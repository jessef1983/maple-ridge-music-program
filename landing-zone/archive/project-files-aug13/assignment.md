...
**16 active assignments.** Four students (Matt, Steph, Greg, Micah) not in the student roster — clarify whether they're continuing or need to be added/removed. Two new assignments added Aug 13: Davis Loewenthal (MPR-048) and Jesse Frase (MPR-015).
...
**4 instruments in storage or incoming.** MPR-019 and 020 need assessment before Sep 4 (only 020 is returnable). MPR-015 assigned to Jesse Frase (ASGN-024).
...
**Euphonium:** Tyler (MPR-013), Kevin R. (Instructor, MPR-014), Jesse Frase (MPR-015), Julian (MPR-016), Joseph (MPR-020)  
**French Horn:** Steph (MPR-017), Greg (MPR-018), Micah (MPR-023)  
**Tuba:** Davis Loewenthal (MPR-048)
