...
**Browsing files:** You can always read `students.md`, `inventory.md`, `assignment.md`, or `sale-inventory.md` directly without using a skill.
...
Skills 1–6 live in the `instrument-inventory` skill. Skill 7, `instrument-sale`, is a separate skill that hands off to Skill 6 once a sale closes, so the fleet record and the disposal pipeline stay in one place each.
 
---
 
## Skills coming soon
 
- **Music Purchasing** — Find and evaluate listings, calculate landed cost
- **NYSSMA Solo Night** — Assign solos, build concert program
- **Music Library** — Add and search sheet music
---
