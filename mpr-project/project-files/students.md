...
## Current roster — sorted by grade
 
### 2nd Grade (Year 1)
*1st graders from last year, bumped to 2nd.*
 
| Name | Last Name | Status | Instrument | MPR |
|---|---|---|---|:---:|
| Michael | Mow | Active | — | — |
| Jeffrey | Huleatt | Active | — | — |
| Jason | Huleatt | Active | — | — |
 
### 3rd Grade (Year 2)
*2nd graders from last year, bumped to 3rd.*
...
### 4th Grade (Year 3)
*3rd graders from last year, bumped to 4th.*
 
| Name | Last Name | Status | Instrument | MPR |
|---|---|---|---|:---:|
| Kristin | Bazeley | Active | — | — |
| Jared | King | Active | — | — |
| Amy | Decker | Active | — | — |
| Dustin | Loewenthal | Active | — | — |
| Oscar | Mow | Active | — | — |
 
### 5th Grade (Year 4)
*4th graders from last year, bumped to 5th.*
 
| Name | Last Name | Status | Instrument | MPR |
|---|---|---|---|:---:|
| Garrett | Loewenthal | Active | — | — |
| Kelian | Zimmermann | Active | — | — |
| Roger | Woolston | Active | — | — |
| Catherine | Rimes | Active | — | — |
| Ian | Maas | Active | — | — |
| Emmanuel | Martinie-Eiler | Active | — | — |
 
### 6th Grade (Year 5)
*5th graders from last year, bumped to 6th.*
...
### 7th Grade (Year 6)
*6th graders from last year, bumped to 7th.*
...
### HS 9th Grade (Year 8, *transfer to HS*)
*Last year's 8th grade middle schoolers, now 9th grade in high school.*
 
| Name | Last Name | Status | Instrument | MPR | Notes |
|---|---|---|---|:---:|---|
...
### HS 10th Grade (Year 9)
*Last year's 9th grade, bumped to 10th.*
...
| Zane | Wipf | Active | — | — |
| Ryan | Loewenthal | Active | — | — |
| Vicky | Horning | Active | — | — |
| Estelle | Rimes | Active | — | — |
| Jacob | Mow | Active | — | — |
 
### HS 11th Grade (Year 10)
*Last year's 10th grade, bumped to 11th.*
 
| Name | Last Name | Status | Instrument | MPR |
|---|---|---|---|:---:|
| Daniel | Warren | Active | — | — |
| Marshall | Landsel | Active | — | — |
| Gina | Scott | Active | — | — |
| Mia | Huleatt | Active | — | — |
| Sianna | Maas | Active | — | — |
| Davis | King | Active | — | — |
| Tressa | Martinie-Eiler | Active | — | — |
| Cooper | Mow | Active | — | — |
 
### HS 12th Grade (Year 11)
*Last year's 11th grade, bumped to 12th (senior year).*
 
| Name | Last Name | Status | Instrument | MPR |
|---|---|---|---|:---:|
| Dominic | Meier | Active | — | — |
| John | Bazeley | Active | — | — |
| Joel | Horning | Active | — | — |
| Brenda | Mow | Active | — | — |
| Ruby | Clement | Active | — | — |
| Jacob | Lorentz | Active | — | — |
| Brandon | Woolston | Active | — | — |
 
---
 
## Summary by cohort
 
| Grade | Year in program | Count |
|:---:|:---:|:---:|
| 2nd | 1 | 3 |
| 3rd | 2 | 6 |
| 4th | 3 | 5 |
...
- **HS transition flag:** Anita Bazeley is the only middle schooler in this snapshot transitioning from 8th to 9th (HS); HS 9th graders (Darron, Sara, etc.) are the next cohort to watch at HS 12th for graduation