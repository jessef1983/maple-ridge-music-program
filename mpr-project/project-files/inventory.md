...
| MPR-081 | TBD | On-hand, program-owned | — | **Brand:** Jupiter. **Model:** JFL 507. **Serial:** P68134 ✅ (verified from instrument). **Outstanding:** acquisition date and cost unknown; condition assessment, case documentation, and physical onboarding photos pending. See `assignment.md` (Christel Mow). |
